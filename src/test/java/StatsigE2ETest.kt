...
class StatsigE2ETest {
    ...
    private val statsigUser : StatsigUser = StatsigUser("123")
    private val randomUser : StatsigUser = StatsigUser("random")
    ...
    fun testFeatureGate() = runBlocking {
        val driver = ServerDriver("secret-testcase", options)
        driver.initialize()
