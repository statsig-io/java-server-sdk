...
public object StatsigForwardProxyGrpcKt {
  ...
  public class StatsigForwardProxyCoroutineStub @JvmOverloads constructor(
    ...
    override fun build(channel: Channel, callOptions: CallOptions): StatsigForwardProxyCoroutineStub
        = StatsigForwardProxyCoroutineStub(channel, callOptions)
     ...
     */
    public suspend fun getConfigSpec(request: StatsigForwardProxyOuterClass.ConfigSpecRequest,
        headers: Metadata = Metadata()): StatsigForwardProxyOuterClass.ConfigSpecResponse =
        unaryRpc(
      channel,
     ...
     */
    public fun streamConfigSpec(request: StatsigForwardProxyOuterClass.ConfigSpecRequest,
        headers: Metadata = Metadata()): Flow<StatsigForwardProxyOuterClass.ConfigSpecResponse> =
        serverStreamingRpc(
      channel,
  ...
  public abstract class StatsigForwardProxyCoroutineImplBase(
     ...
     */
    public open suspend fun getConfigSpec(request: StatsigForwardProxyOuterClass.ConfigSpecRequest):
        StatsigForwardProxyOuterClass.ConfigSpecResponse = throw
     ...
     * @param request The request from the client.
     */
    public open fun streamConfigSpec(request: StatsigForwardProxyOuterClass.ConfigSpecRequest):
        Flow<StatsigForwardProxyOuterClass.ConfigSpecResponse> = throw
